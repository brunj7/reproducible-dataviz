...
- From GUI
- Using keyboard code chnuk: `Ctrl` + `Alt` + `I` (`Cmd` + `Option` + `I` on macOS).
...
```
mmm, we do not want the `Tidyverse` message...
...
You can use html widgets to add som interactivity to your R markdown documents



You can render tables in R Markdown
...
For example, we coul want to save all our plots in a specific folder:
...
Want to know your default knit option?
